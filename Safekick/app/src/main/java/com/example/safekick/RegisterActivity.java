    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                Response.Listener<String> responseListener = new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            String as = "{";
                            int str = response.indexOf("{");
                            //response = response.substring(str+1);
                            //Log.d("잘라낸 문자열",response);
                            //response = as+response;
                            //Log.d("완성된 문자열",response);
        ...
        join_button.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RegisterRequest registerRequest = new RegisterRequest( UserEmail, UserPwd, UserName, UserAuth,responseListener);
                RequestQueue queue = Volley.newRequestQueue( RegisterActivity.this );
